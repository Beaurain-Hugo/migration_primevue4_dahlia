  ...
  <div class="body">
    <div class="box">
      ...
      <div class="in">
        ...
        <div>
          <input type="text" v-model="nom" placeholder="Entrer votre Nom" /><img v-if="nom.length >= 3" src="../assets/ok.svg" alt="" />
        </div>

        <label for="name">Prenom</label>
        <div>
          <input type="text" v-model="prenom" placeholder="Entrer votre Prenom" /><img
        ...
        <div>
          <input type="text" v-model="mail" placeholder="Entrer votre adresse mail" /><img
            v-if="mail.length >= 6"
            src="../assets/ok.svg"
            alt=""
          />
      ...
      <div class="in">
        ...
        <div>
          <v-text-field type="password">
            <input v-model="password_confirmation" type="password" placeholder="8 caracteres minimum" required /><img
        ...
        <div>
          <v-text-field type="password">
            <input v-model="password" type="password" placeholder="Confirmer le mot de passe ..." required /><img
              v-if="!password_confirmation"
              style="display: none"
              src="../assets/ok.svg"
              alt=""
            /><img v-else-if="password === password_confirmation" src="../assets/ok.svg" alt="" />
          </v-text-field>
        </div>
      </div>

      <div class="check_bar">
        <div><input type="checkbox" name="" id="" /> <label for="">Se souvenir de moi</label></div>
